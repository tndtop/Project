...
<header class="w3-display-container w3-content w3-center w3-indigo" style="max-width:1500px">
  ...
  <div class="w3-bar w3-light-grey w3-round w3-display-bottommiddle w3-hide-small" style="bottom:360px">
    ...
    <a href="coffee.html" class="w3-bar-item w3-button w3-hover-amber">Coffee & Health</a>
  ...
  <div class="w3-row-padding">
   <div class="w3-col l3 m6 w3-margin-bottom">
     <div class="w3-display-container">
       ...
       <a href="samo.html"><img src="DSCF7854.JPG" alt="monday"class="w3-hover-opacity" style="width:100%"></a>
   ...
   <div class="w3-col l3 m6 w3-margin-bottom">
     <div class="w3-display-container">
       ...
       <a href="thestory.html"><img src="DSCF7717.JPG" alt="The Story"class="w3-hover-opacity" style="width:100%"></a>
       <div class="w3-display-middle w3-wide w3-text-light-grey w3-center">
   ...
   <div class="w3-col l3 m6 w3-margin-bottom">
     <div class="w3-display-container">
       ...
       <a href="monday.html"><img src="DSCF7673.JPG" alt="im house"class="w3-hover-opacity" style="width:100%"></a>
       <div class="w3-display-middle w3-wide w3-text-light-grey w3-center">
   ...
   <div class="w3-col l3 m6 w3-margin-bottom">
     <div class="w3-display-container">
       ...
       <a href="imhouse.html"><img src="DSCF7724.JPG" alt="samo"class="w3-hover-opacity"style="width:100%"></a>
